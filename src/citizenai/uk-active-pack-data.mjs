import { UK_RELEASE_CANDIDATE_PACK, UK_RELEASE_CANDIDATE_MANIFEST } from './uk-release-candidate.mjs';
import { UK_RC4_COVERAGE_CERTIFICATION } from './uk-rc4-approval.mjs';

const PUBLISHED_AT = '2026-09-02T11:09:23.000Z';
const CERTIFIED_CONTENT_DIGEST = '5a36b00e7fa71320e8a68d0cc4cd27bfeb872ae5de3469a6af941045c80e89c0';
...
export const UK_ACTIVE_PACK_MANIFEST = Object.freeze({
  ...
  contentDigest: CERTIFIED_CONTENT_DIGEST,
...
export function validateUkActivePackData() {
  const errors = [];
  ...
  if (UK_ACTIVE_PACK_MANIFEST.contentDigest !== CERTIFIED_CONTENT_DIGEST) errors.push('certified_content_digest_mismatch');
